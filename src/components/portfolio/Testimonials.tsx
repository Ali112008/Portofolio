        ...
        <div className="grid md:grid-cols-3 gap-5">
          {visible.map((t, i) => (
            <Reveal
              ...
              className="flex"
            >
              <figure className="group relative flex flex-col min-h-[220px] w-full p-5 rounded-2xl border border-border bg-surface/80 backdrop-blur-sm hover:border-primary/40 hover:bg-surface transition-all duration-300">
